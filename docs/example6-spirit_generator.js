addExample("spirit generator", () => {
  function run() {
    var grammar = {
      ...
      spirit_homes: ["prison", "cocoon", "palace", "void", "fortress", "egg"],
      ...
      sub_pronoun: [
        "#map(gender, male=>he, female=>she, neuter=>they, none=>it, both=>they)#",
      ],
      pos_pronoun: [
        "#map(gender, male=>his, female=>her, neuter=>their, none=>its, both=>their)#",
      ],

      possesive: [
        "#map(gender, male=>has, female=>has, neuter=>have, none=>has, both=>have)#",
      ],
      ...
      origin: [
        `#[gender:genders]# #[name:names.capitalize]# #[spirit:spirit_types]# #[place:spirit_places]#
